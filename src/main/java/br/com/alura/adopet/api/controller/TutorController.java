...
public class TutorController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<String> cadastrar(@RequestBody @Valid DadosDeCadastroTutorDto dto) {
        try {
    ...
    @PutMapping
    @Transactional
    public ResponseEntity<String> atualizar(@RequestBody @Valid DadosParaAtualizacaoTutorDto dto) {
        try {
